...
#let render-cadence(data, variant: "default", theme: "cadence") = {
  let t = (ink: rgb("#20282e"), accent: rgb("#2f7066"), muted: rgb("#6f7c79"), marker: rgb("#2f7066"), link: rgb("#2f7066"), name-fill: rgb("#20282e"), headline-fill: rgb("#2f7066"), company-fill: rgb("#2f7066"))
  ...
  set page(paper: "a4", margin: (x: 1.32cm, y: 1.08cm), footer: render-footer(t, name))
  ...
  align(center)[
    ...
    #v(0.18em)#text(size: 7.6pt, fill: t.muted)[#{
  ...
  v(0.20em); line(length: 100%, stroke: 1.3pt + t.accent)

  let section(title, body) = {
    v(0.88em)
    text(size: 8.6pt, weight: "bold", tracking: 0.13em, fill: t.accent)[#upper(title)]
    v(0.07em); line(length: 100%, stroke: 0.4pt + rgb("#d7e1de")); v(0.23em); body
  }
