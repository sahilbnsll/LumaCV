// ============================================================
// Template: Gallery (Portfolio) — Curated Exhibition Layout
// ============================================================
// Design principles:
//  - Vibrant ocean teal (#167c80) & deep petrol-charcoal ink (#19333b)
//  - Curated exhibition framing with soft ice-teal tinted pill blocks
//  - High-contrast typography: bold teal section anchors, dark ink item titles, muted slate metadata
...
#let render-portfolio(data, variant: "default", theme: "portfolio") = {
  let default-palette = (
    ...
    muted: rgb("#586e75"),
    soft: rgb("#eef7f6"),
    stroke-line: rgb("#c2dedd"),
    marker: rgb("#167c80"),
    link: rgb("#167c80"),
    name-fill: rgb("#19333b"),
    headline-fill: rgb("#167c80"),
    company-fill: rgb("#167c80"),
  )
  ...
  set page(paper: pg.paper, margin: (x: 1.25cm, top: 1.35cm, bottom: 1.60cm), footer: render-footer(t, name))
  ...
  set list(indent: 0.90em, body-indent: 0.35em, spacing: 0.38em, marker: (text(fill: accent)[•], text(fill: accent)[–]))
  ...
  // Header Block (Gallery Masthead with Tinted Capsule)
  align(left)[
    #text(size: 23pt, weight: "bold", fill: ink)[#name]
    #if headline != "" [
      #v(0.08em)
      #text(size: 9.3pt, weight: "bold", fill: accent)[#headline]
    ]
  ]
  v(0.20em)
  block(
  ...
  for sec in active-order {
    if sec == "summary" {
      if summary != "" { section("Curator Profile", parse-bold(summary)) }
      ...
      if "keyMetrics" in data and data.keyMetrics != none and data.keyMetrics.len() > 0 {
        section("Scale & Exhibition Impact", breakable: false, {
          ...
          for (i, exp) in data.experience.enumerate() {
            ...
            block(width: 100%, breakable: false, {
              grid(
                ...
                text(size: 9.1pt, weight: "bold", fill: ink)[#exp.role],
                text(size: 8.0pt, fill: muted)[#exp.dates],
              )
              v(0.08em)
              text(size: 8.3pt, weight: "bold", fill: accent)[#exp.company]
              if "location" in exp and exp.location != "" [#text(size: 7.7pt, fill: muted)[ · #exp.location]]
              let all-bullets = ()
      ...
      if "internships" in data and data.internships.len() > 0 {
        section("Internships & Residencies", breakable: false, {
      ...
      if projects != () and projects.len() > 0 {
        section("Exhibited Projects & Transformations", breakable: false, {
          for (i, proj) in projects.enumerate() {
            ...
            block(width: 100%, breakable: false, {
              grid(
                ...
                if "dates" in proj and proj.dates != "" { text(size: 8pt, fill: muted)[#proj.dates] }
              )
          ...
          for (i, lead) in data.leadership.enumerate() {
            ...
            block(width: 100%, breakable: false, {
              grid(
                ...
                text(size: 7.9pt, fill: muted)[#if "dates" in lead { lead.dates }]
              )
          ...
          for (i, pat) in data.patents.enumerate() {
            ...
            block(width: 100%, breakable: false, {
              grid(
                ...
                text(size: 7.8pt, fill: muted)[#if "date" in pat { pat.date }]
              )
