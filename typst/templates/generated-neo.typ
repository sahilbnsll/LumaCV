// ============================================================
// Template: Avant (Neo) — Modern Digital Contrast & Soft Pill
// ============================================================
...
#let render-neo(data, variant: "default", theme: "neo") = {
  let default-palette = (
    ...
    accent: rgb("#634bd8"),
    soft: rgb("#f2effe"),
    stroke-line: rgb("#dfd8fa"),
    marker: rgb("#634bd8"),
    link: rgb("#634bd8"),
    name-fill: rgb("#ffffff"),
    headline-fill: rgb("#e8e3ff"),
    company-fill: rgb("#634bd8"),
  )
  ...
  // Header Block (Avant Signature Purple Pill)
  block(width: 100%, breakable: false, {
    grid(
      ...
      block(
        ...
        radius: 4pt,
        {
          text(size: 19pt, weight: "bold", fill: white)[#name]
          if headline != "" [
            \ #v(0.06em)
            #text(size: 9.0pt, weight: "medium", fill: rgb("#e8e3ff"))[#headline]
          ]
        }
      ),
      align(right)[
    ...
    block(width: 100%, breakable: breakable, {
      block(above: 0pt, below: 0.50em, breakable: false, sticky: true, width: 100%, {
        block(
          ...
          radius: 3pt,
          width: 100%,
          text(size: 8.6pt, weight: "bold", fill: accent, tracking: 0.12em)[#heading(level: 2, outlined: true, bookmarked: true, upper(title))]
        )
      })
      body
    })
        ...
        section("Key Performance Metrics", breakable: false, {
          ...
          grid(
            ...
            ..data.keyMetrics.map(km => block(
              ...
              width: 100%,
              align(center)[
                #text(size: 9.8pt, weight: "bold", fill: accent)[#km.value] \
                #v(0.04em)
