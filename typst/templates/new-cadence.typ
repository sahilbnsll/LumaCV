...
#let render-cadence(data, variant: "default", theme: "cadence") = {
  let t = (
    ink: rgb("#20282e"),
    accent: rgb("#2f7066"),
    accent-soft: rgb("#f2f8f7"),
    border-line: rgb("#d7e1de"),
    border-soft: rgb("#e2ebe9"),
    muted: rgb("#6f7c79"),
    marker: rgb("#2f7066"),
    link: rgb("#2f7066"),
    name-fill: rgb("#20282e"),
    headline-fill: rgb("#2f7066"),
  )
  ...
  set page(
    paper: "a4",
    margin: (x: 1.3cm, top: 1.2cm, bottom: 1.25cm),
  ...
  set list(indent: 0.85em, body-indent: 0.35em, spacing: 0.36em, marker: (text(fill: t.accent, "•"), text(fill: t.muted, "–")))
  show link: set text(fill: t.link)
  show heading: it => it.body

  // Centered Signature Header
  align(center)[
    #text(size: 21pt, weight: "bold", fill: t.name-fill)[#name]
    #if headline != "" [
      \ #v(0.08em)
      #text(size: 9.2pt, weight: "medium", fill: t.headline-fill)[#headline]
    ]
    #v(0.20em)
    ...
    block(
      ...
      breakable: breakable,
      {
        block(
          ...
          width: 100%,
          {
            text(size: 8.9pt, weight: "bold", tracking: 0.12em, fill: t.accent)[#upper(title)]
            v(0.08em)
            line(length: 100%, stroke: 0.5pt + t.border-line)
          }
        )
        body
      }
    ...
    if sec == "summary" {
      ...
      if "techStackSummary" in data and data.techStackSummary != none and data.techStackSummary != "" {
        section("Core Tech Stack", block(
          fill: t.accent-soft,
          stroke: 0.5pt + t.border-soft,
          inset: (x: 0.7em, y: 0.45em),
          radius: 2.5pt,
          width: 100%,
          text(size: 8.4pt)[#text(weight: "bold", fill: t.ink)[Core Technologies: ] #parse-bold(data.techStackSummary)]
        ))
      }
        ...
        section("Key Performance Indicators", {
          ...
          grid(
            ...
            ..data.keyMetrics.map(km => block(
              ...
              width: 100%,
              align(center)[
                #text(size: 10.5pt, weight: "bold", fill: t.accent)[#km.value] \
                #v(0.08em)
                #text(size: 7.6pt, weight: "bold", fill: t.ink)[#km.label]
                #if "context" in km and km.context != "" [
                  \ #v(0.05em)
                  #text(size: 7pt, fill: t.muted)[#km.context]
                ]
              ]
            ))
          )
          ...
          for (i, exp) in data.experience.enumerate() {
            ...
            block(width: 100%, breakable: false, {
              grid(
                ...
                [#text(size: 9pt, weight: "bold", fill: t.ink)[#exp.role] #text(fill: t.accent)[·] #text(weight: "bold", fill: t.ink)[#exp.company]],
              ...
              if ("location" in exp and exp.location != "") or ("technologies" in exp and exp.technologies != "") {
                ...
                grid(
                  ...
                  if "technologies" in exp and exp.technologies != "" { text(size: 7.6pt, fill: t.muted)[Stack: #exp.technologies] }
                )
              }
              let all-bullets = ()
          ...
          for (i, proj) in projects.enumerate() {
            ...
            block(width: 100%, breakable: false, {
              ...
              if "stack" in proj and proj.stack != "" {
                v(0.06em)
                text(size: 7.7pt, weight: "medium", fill: t.accent)[Stack: #proj.stack]
              }
      ...
      if "education" in data and data.education.len() > 0 {
        section("Education", {
          for (i, edu) in data.education.enumerate() {
            ...
            grid(
              columns: (1fr, auto),
              [#text(size: 8.3pt, fill: t.ink)[#edu.degree#if "specialization" in edu and edu.specialization != "" [ · #edu.specialization]]],
