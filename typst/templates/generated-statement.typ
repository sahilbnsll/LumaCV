// ============================================================
// Template: Statement (Keynote) — Bold Modern Keynote Design
// ============================================================
// Design principles:
//  - Iconic '/' keynote slash branding in header and section markers
//  - Warm terracotta/slate palette, high contrast, clean card elements
//  - Complete 22+ field support with bold typographic punch
...
#let render-statement(data, variant: "default", theme: "statement") = {
  let default-palette = (
    ...
    marker: rgb("#d26b2a"),
    link: rgb("#d26b2a"),
    name-fill: rgb("#2c2f33"),
    headline-fill: rgb("#d26b2a"),
    company-fill: rgb("#d26b2a"),
  )
  ...
  let accent-bg = if "accent" in t { t.accent.lighten(94%) } else { rgb("#fff4ec") }
  let stroke-line = if "accent" in t { t.accent.lighten(70%) } else { rgb("#ead9cb") }

  set document(title: if headline != "" { name + " — " + headline } else { name + " — Resume" }, author: name, date: none)
  set page(paper: pg.paper, margin: (x: 1.30cm, y: 1.25cm), footer: render-footer(t, name))
  ...
  grid(
    ...
    text(size: 42pt, weight: "bold", fill: t.accent)[/],
    [
      ...
      #v(0.14em)
      #text(size: 7.9pt, fill: t.muted)[#contact-text]
    ]
  )
  v(0.16em)
  ...
  let section(title, body, breakable: true) = {
    ...
    block(width: 100%, breakable: breakable, [
      #block(above: 0pt, below: 0.16em, breakable: false, sticky: true, width: 100%, [
        #grid(columns: (auto, 1fr), column-gutter: 0.38em, align: (left + horizon, left + horizon),
          text(size: 13pt, weight: "bold", fill: t.accent)[/],
          text(size: 9.1pt, weight: "bold", tracking: 0.08em, fill: t.accent)[#heading(level: 2, outlined: true, bookmarked: true, upper(title))]
        )
        #v(0.08em)
        #line(length: 100%, stroke: 0.50pt + stroke-line)
      ])
      #v(0.20em)
      #body
    ])
  ...
  for sec in active-order {
    if sec == "summary" {
      if summary != "" { section("Executive Statement", parse-bold(summary)) }
    } else if sec == "techStackSummary" {
      if "techStackSummary" in data and data.techStackSummary != none and data.techStackSummary != "" {
        section("Platform & Stack Focus", block(
          fill: accent-bg,
          stroke: 0.5pt + stroke-line,
          inset: (x: 7pt, y: 4.5pt),
          radius: 2pt,
          width: 100%,
          text(size: 8.2pt)[#text(weight: "bold", fill: t.company-fill)[Core Technologies:] #parse-bold(data.techStackSummary)]
        ))
      }
        ...
        section("Core Competencies & Stack", {
          for cat in skills {
            ...
            grid(
              columns: (1.4fr, 2.6fr),
              column-gutter: 1.0em,
              text(size: 8.4pt, weight: "bold", fill: t.company-fill)[#cat.category],
        ...
        section("Professional Experience", {
          for (i, exp) in data.experience.enumerate() {
            ...
            block(width: 100%, breakable: false, {
              ...
              v(0.02em)
              text(size: 8.4pt, weight: "bold", fill: t.company-fill)[#exp.company#if "location" in exp and exp.location != "" [ · #text(weight: "regular", fill: t.muted)[#exp.location]]]
              let all-bullets = ()
          ...
          for (i, proj) in projects.enumerate() {
            ...
            block(width: 100%, breakable: false, {
              grid(
                ...
                if "dates" in proj and proj.dates != "" { text(size: 8.0pt, fill: t.muted)[#proj.dates] }
              )
        ...
        section("Certifications & Credentials", breakable: false, {
          for (i, cert) in data.certifications.enumerate() {
            ...
            grid(
              ...
              text(size: 8.0pt, fill: t.muted)[#if "date" in cert { cert.date }]
            )
          }
        })
      }
          ...
          section("Honors & Awards", breakable: false, {
            for (i, ach) in items.enumerate() {
              ...
              grid(
                ...
                text(size: 8.0pt, fill: t.muted)[#if "date" in ach { ach.date }]
              )
        ...
        section("Open Source Architecture", breakable: false, {
          for (i, item) in data.openSource.enumerate() {
            ...
            grid(
              ...
              text(size: 8.0pt, fill: t.muted)[#if "dates" in item { item.dates }]
            )
        ...
        section("Publications", breakable: false, {
          for (i, pub) in data.publications.enumerate() {
            ...
            grid(
              ...
              text(size: 8.0pt, fill: t.muted)[#if "date" in pub { pub.date }]
            )
        ...
        section("Advisory & Leadership", breakable: false, {
          for (i, lead) in data.leadership.enumerate() {
            ...
            grid(
              ...
              text(size: 8.0pt, fill: t.muted)[#if "dates" in lead { lead.dates }]
            )
        ...
        section("Community & Volunteering", breakable: false, {
          for (i, vol) in data.volunteering.enumerate() {
            ...
            grid(
              ...
              text(size: 8.0pt, fill: t.muted)[#if "dates" in vol { vol.dates }]
            )
        ...
        section("Conferences & Presentations", breakable: false, {
          for (i, conf) in data.conferences.enumerate() {
            ...
            grid(
              ...
              text(size: 8.0pt, fill: t.muted)[#if "date" in conf { conf.date }]
            )
        ...
        section("Patents & IP", breakable: false, {
          for (i, pat) in data.patents.enumerate() {
            ...
            grid(
              ...
              text(size: 8.0pt, fill: t.muted)[#if "date" in pat { pat.date }]
            )
        ...
        section("Products", breakable: false, {
          for (i, prod) in data.products.enumerate() {
            ...
            grid(
              ...
              text(size: 8.0pt, fill: t.muted)[#if "dates" in prod { prod.dates }]
            )
