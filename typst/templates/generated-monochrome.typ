// ============================================================
// Template: Monochrome — Pure Stark Typography & Ink on Paper
// ============================================================
...
#let render-monochrome(data, variant: "default", theme: "monochrome") = {
  let default-palette = (
    ...
    accent: rgb("#111111"),
    soft: rgb("#f5f5f5"),
    stroke-line: rgb("#d0d0d0"),
    marker: rgb("#111111"),
    link: rgb("#111111"),
    name-fill: rgb("#111111"),
    headline-fill: rgb("#555555"),
    company-fill: rgb("#111111"),
  )
  ...
  set list(indent: 0.90em, body-indent: 0.35em, spacing: 0.38em, marker: (text(fill: ink, size: 7.5pt)[●], text(fill: ink, size: 7.5pt)[–]))
  ...
  // Header Block (Minimal Monochrome Editorial)
  block(width: 100%, breakable: false, {
    grid(
      ...
      [
        #text(size: 22pt, weight: "bold", tracking: 0.02em)[#upper(name)]
        #if headline != "" [
          \ #v(0.06em)
          #text(size: 9.2pt, weight: "medium", fill: muted)[#headline]
        ]
      ],
      align(right)[
  ...
  let section(title, body, breakable: true) = {
    ...
    block(width: 100%, breakable: breakable, {
      block(above: 0pt, below: 0.50em, breakable: false, sticky: true, width: 100%, {
        stack(
          spacing: 0.28em,
          text(size: 8.6pt, weight: "bold", fill: ink, tracking: 0.16em)[#heading(level: 2, outlined: true, bookmarked: true, upper(title))],
        ...
        section("Professional Experience", {
          for (i, exp) in data.experience.enumerate() {
            ...
            block(width: 100%, breakable: false, [
              ...
              #v(0.08em)
              #text(size: 8.3pt, weight: "bold", fill: ink)[#exp.company#if "location" in exp and exp.location != "" [ #text(weight: "regular", fill: muted)[· #exp.location]]]
              #v(0.26em)
        ...
        section("Education", breakable: false, {
          for (i, edu) in data.education.enumerate() {
            ...
            block(width: 100%, breakable: false, {
              ...
              grid(
                columns: (1fr, auto),
                [#text(size: 8.3pt, fill: muted)[#edu.institution#if "location" in edu and edu.location != "" [ · #edu.location]]],
              ...
              [
                #grid(
                  ...
                  [
                    ...
                    #if "url" in proj and proj.url != "" [ #link(proj.url)[#text(size: 7.8pt, fill: ink)[ ↗]]]
                  ],
            ...
            block(width: 100%, breakable: false, {
              grid(
                ...
                [
                  ...
                  #if "organization" in item and item.organization != "" [ #text(weight: "medium", fill: muted)[ @ #item.organization] ]
                ],
                text(size: 7.9pt, fill: muted)[#if "dates" in item { item.dates }]
              )
              if "bullets" in item and item.bullets.len() > 0 {
