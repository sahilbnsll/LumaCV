...
#let render-meridian(data, variant: "default", theme: "meridian") = {
  let t = (ink: rgb("#22272e"), accent: rgb("#31536d"), muted: rgb("#6b7782"), marker: rgb("#31536d"), link: rgb("#31536d"), name-fill: rgb("#22272e"), headline-fill: rgb("#31536d"), company-fill: rgb("#31536d"))
  ...
  set page(paper: "a4", margin: (x: 1.55cm, y: 1.34cm), footer: render-footer(t, name))
  ...
  align(left)[
    #text(size: 23pt, weight: "bold", fill: t.name-fill)[#name]
    #if headline != "" [#v(0.10em)#text(size: 9.2pt, style: "italic", fill: t.headline-fill)[#headline]]
  ]
  v(0.18em)
  ...
  let section(title, body) = {
    ...
    block(breakable: false, sticky: true, width: 100%, {
      text(size: 8.8pt, weight: "bold", tracking: 0.16em, fill: t.accent)[#upper(title)]
      v(0.09em)
      line(length: 34pt, stroke: 1.2pt + t.accent)
    })
    v(0.25em)
    body
  }
