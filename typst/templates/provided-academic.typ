// ============================================================
// Template: Scholar (Academic) — Formal Academic Curriculum Vitae
// ============================================================
...
#let render-academic(data, variant: "default", theme: "academic") = {
  let default-palette = (
    ...
    accent: rgb("#27272a"),
    soft: rgb("#f4f4f5"),
    stroke-line: rgb("#d4d4d8"),
    marker: rgb("#27272a"),
    link: rgb("#18181b"),
    name-fill: rgb("#18181b"),
    headline-fill: rgb("#52525b"),
    company-fill: rgb("#27272a"),
  )
  ...
  set document(title: if headline != "" { name + " — " + headline } else { name + " — Curriculum Vitae" }, author: name, date: none)
  set page(
    paper: pg.paper,
    margin: (x: 1.35cm, top: 1.35cm, bottom: 1.65cm),
  ...
  // Header Block (Scholar Academic Center Masthead)
  block(width: 100%, breakable: false, {
    align(center)[
      ...
      #v(0.18em)
      #text(size: 8.2pt, fill: ink)[#contact-items.join([ #text(fill: muted)[·] ])]
    ]
    v(0.30em)
  ...
  let section(title, body, breakable: true) = {
    ...
    block(width: 100%, breakable: breakable, {
      block(above: 0pt, below: 0.50em, breakable: false, sticky: true, width: 100%, {
        stack(
          spacing: 0.28em,
          text(size: 8.8pt, weight: "bold", fill: accent, tracking: 0.12em)[#heading(level: 2, outlined: true, bookmarked: true, upper(title))],
  ...
  for sec in active-order {
    if sec == "summary" {
      if summary != "" {
        section("Research & Professional Summary", parse-bold(summary))
      }
      ...
      if "techStackSummary" in data and data.techStackSummary != none and data.techStackSummary != "" {
        section("Technical Stack", breakable: false, block(
          ...
          radius: 2pt,
          width: 100%,
          text(size: 8.4pt)[#text(weight: "bold", fill: ink)[Core Stack:] #parse-bold(data.techStackSummary)]
        ))
      }
    } else if sec == "skills" {
      if skills != () and skills.len() > 0 {
        section("Technical & Research Competencies", breakable: false, {
      ...
      if "keyMetrics" in data and data.keyMetrics != none and data.keyMetrics.len() > 0 {
        section("Key Performance Indicators", breakable: false, {
          ...
          grid(
            ...
            ..data.keyMetrics.map(km => block(
              ...
              width: 100%,
              align(center)[
                #text(size: 9.8pt, weight: "bold", fill: ink)[#km.value] \
                #v(0.04em)
          ...
          for (i, exp) in data.experience.enumerate() {
            ...
            block(width: 100%, breakable: false, [
              #grid(
                columns: (1fr, auto),
                column-gutter: 0.6em,
                text(size: 9.3pt, weight: "bold", fill: ink)[#exp.role, #text(style: "italic", weight: "regular")[#exp.company]],
                text(size: 8.2pt, fill: muted)[#exp.dates]
              )
      ...
      if "internships" in data and data.internships.len() > 0 {
        section("Internships & Research Residencies", breakable: false, {
          ...
          for (i, edu) in data.education.enumerate() {
            ...
            block(width: 100%, breakable: false, {
              grid(
                columns: (1fr, auto),
                column-gutter: 0.6em,
                text(weight: "bold", fill: ink)[#edu.degree#if "specialization" in edu and edu.specialization != "" [ · #text(weight: "regular", style: "italic")[#edu.specialization]]],
                text(size: 8.2pt, fill: muted)[#edu.dates]
              )
              v(0.04em)
              grid(
                columns: (1fr, auto),
                [#text(size: 8.4pt, style: "italic")[#edu.institution#if "location" in edu and edu.location != "" [ · #text(style: "normal", fill: muted)[#edu.location]]]],
                if "gpa" in edu and edu.gpa != "" { text(size: 8.0pt, fill: muted)[GPA: #edu.gpa] }
              )
            })
          }
        })
      ...
      if projects != () and projects.len() > 0 {
        section("Key Projects & Research Systems", breakable: false, {
              ...
              [
                #grid(
                  ...
                  [
                    ...
                    #if "role" in proj and proj.role != "" [ #text(size: 7.8pt, style: "italic", fill: muted)[· #proj.role]]
                    #if "url" in proj and proj.url != "" [ #link(proj.url)[#text(size: 7.8pt)[ ↗]]]
                  ],
                  if "dates" in proj and proj.dates != "" { text(size: 8.0pt, fill: muted)[#proj.dates] }
                )
                #if "stack" in proj and proj.stack != "" [
                  #v(0.06em)
                  #text(size: 7.6pt, weight: "bold", fill: muted)[Stack: #proj.stack]
                ]
            ...
            block(width: 100%, breakable: false, {
              grid(
                ...
                [
                  ...
                  #if "url" in cert and cert.url != "" [ #link(cert.url)[#text(fill: ink)[ ↗]] ]
                  #if "issuer" in cert and cert.issuer != "" [ #text(fill: muted)[ · #cert.issuer] ]
                ],
                text(size: 8.0pt, fill: muted)[#if "date" in cert { cert.date }]
              )
            })
          }
        })
              ...
              block(width: 100%, breakable: false, {
                grid(
                  ...
                  [
                    ...
                    #if "url" in ach and ach.url != "" [ #link(ach.url)[#text(fill: ink)[ ↗]] ]
                  ],
                  text(size: 8.0pt, fill: muted)[#if "date" in ach { ach.date }]
                )
                if "description" in ach and ach.description != "" {
                  v(0.04em)
                  text(size: 8.2pt, fill: ink)[#parse-bold(ach.description)]
                }
              })
            }
          })
      ...
      if "openSource" in data and data.openSource.len() > 0 {
        section("Open Source & Scientific Software", breakable: false, {
            ...
            block(width: 100%, breakable: false, {
              grid(
                ...
                [
                  ...
                  #if "url" in item and item.url != "" [ #link(item.url)[#text(fill: ink)[ ↗]] ]
                  #if "contribution" in item and item.contribution != "" [ #text(fill: muted)[ · #item.contribution] ]
                ],
                text(size: 8.0pt, fill: muted)[#if "dates" in item { item.dates }]
              )
              if "bullets" in item and item.bullets.len() > 0 {
                ...
                v(0.06em)
                text(size: 8.2pt, fill: ink)[#parse-bold(item.impact)]
              }
            })
          }
        })
      ...
      if "publications" in data and data.publications.len() > 0 {
        section("Publications & Working Papers", breakable: false, {
            ...
            block(width: 100%, breakable: false, {
              grid(
                ...
                [
                  ...
                  #if "url" in pub and pub.url != "" [ #link(pub.url)[#text(fill: ink)[ ↗]] ]
                  #if "publisher" in pub and pub.publisher != "" [ #text(style: "italic", fill: muted)[ · #pub.publisher] ]
                ],
                text(size: 8.0pt, fill: muted)[#if "date" in pub { pub.date }]
              )
            })
          }
        })
      ...
      if "leadership" in data and data.leadership.len() > 0 {
        section("Academic & Community Leadership", breakable: false, {
            ...
            block(width: 100%, breakable: false, {
              grid(
                ...
                [
                  ...
                  #if "organization" in item and item.organization != "" [ #text(style: "italic", fill: muted)[ @ #item.organization] ]
                ],
                text(size: 8.0pt, fill: muted)[#if "dates" in item { item.dates }]
              )
              if "bullets" in item and item.bullets.len() > 0 {
      ...
      if "volunteering" in data and data.volunteering.len() > 0 {
        section("Service & Volunteering", breakable: false, {
            ...
            block(width: 100%, breakable: false, {
              grid(
                ...
                [
                  ...
                  #if "organization" in vol and vol.organization != "" [ #text(style: "italic", fill: muted)[ @ #vol.organization] ]
                ],
                text(size: 8.0pt, fill: muted)[#if "dates" in vol { vol.dates }]
              )
      ...
      if "conferences" in data and data.conferences.len() > 0 {
        section("Conferences & Invited Talks", breakable: false, {
            ...
            block(width: 100%, breakable: false, {
              grid(
                ...
                [
                  ...
                  #if "role" in conf and conf.role != "" [ #text(style: "italic", fill: muted)[ · #conf.role] ]
                ],
                text(size: 8.0pt, fill: muted)[#if "date" in conf { conf.date }]
              )
              if "details" in conf and conf.details != "" {
                v(0.04em)
                text(size: 8.2pt, fill: ink)[#parse-bold(conf.details)]
              }
            })
          }
        })
      ...
      if "languages" in data and data.languages.len() > 0 {
        section("Languages", breakable: false, {
          let items = data.languages.map(l => [
            ...
            #if "fluency" in l and l.fluency != "" [ (#text(style: "italic", fill: muted)[#l.fluency])]
          ])
      ...
      if "interests" in data and data.interests.len() > 0 {
        section("Interests", breakable: false, {
          ...
          text(size: 8.4pt, fill: ink)[#items.filter(x => x != "").join([ #text(fill: stroke-line)[ · ] ])]
        })
      }
    } else if sec == "patents" {
      if "patents" in data and data.patents.len() > 0 {
        section("Patents & Inventions", breakable: false, {
          for (i, pat) in data.patents.enumerate() {
            ...
            block(width: 100%, breakable: false, {
              grid(
                ...
                text(size: 8.0pt, fill: muted)[#if "date" in pat { pat.date }]
              )
            })
          }
        })
      ...
      if "products" in data and data.products.len() > 0 {
        section("Products Developed", breakable: false, {
            ...
            block(width: 100%, breakable: false, {
              grid(
                ...
                [
                  ...
                  #if "url" in prod and prod.url != "" [ #link(prod.url)[#text(fill: ink)[ ↗]] ]
                ],
                text(size: 8.0pt, fill: muted)[#if "dates" in prod { prod.dates }]
              )
              if "description" in prod and prod.description != "" {
                v(0.04em)
                text(size: 8.2pt, fill: ink)[#parse-bold(prod.description)]
              }
            })
          }
        })
      ...
      if "devopsContributions" in data and data.devopsContributions.len() > 0 {
        section("Infrastructure & DevOps Contributions", breakable: false, {
      ...
      if "securityContributions" in data and data.securityContributions.len() > 0 {
        section("Security & Verification Contributions", breakable: false, {
