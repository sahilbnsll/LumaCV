...
#let colors = (
  ...
  // Onyx — Minimal high-contrast monochrome
  onyx: (
    ink: rgb("#09090B"),
    muted: rgb("#52525B"),
    accent: rgb("#18181B"),
    ...
    link: rgb("#09090B"),
    marker: rgb("#27272A"),
    name-fill: rgb("#09090B"),
    company-fill: rgb("#18181B"),
    headline-fill: rgb("#52525B"),
    skill-label: rgb("#18181B"),
    skill-bg: rgb("#F4F4F5"),
    skill-border: rgb("#E4E4E7"),
  ),
  // Glalie — Asymmetric executive slate with cool azure accents
  glalie: (
    ink: rgb("#0F172A"),
    muted: rgb("#475569"),
    accent: rgb("#0284C7"),
    ...
    name-fill: rgb("#0F172A"),
    company-fill: rgb("#0F172A"),
    headline-fill: rgb("#0284C7"),
    skill-label: rgb("#0F172A"),
    skill-bg: rgb("#F0F9FF"),
    skill-border: rgb("#BAE6FD"),
  ),
  // Azurill — High-density tech indigo & electric blue
  azurill: (
    ink: rgb("#0F172A"),
    muted: rgb("#475569"),
    accent: rgb("#2563EB"),
    ...
    marker: rgb("#3B82F6"),
    name-fill: rgb("#0F172A"),
    company-fill: rgb("#1D4ED8"),
    headline-fill: rgb("#2563EB"),
    skill-label: rgb("#1D4ED8"),
    skill-bg: rgb("#EFF6FF"),
    skill-border: rgb("#DBEAFE"),
  ),
  // Chikorita — Organic editorial sage and warm charcoal
  chikorita: (
    ink: rgb("#1C1917"),
    muted: rgb("#57534E"),
    accent: rgb("#15803D"),
    ...
    link: rgb("#16A34A"),
    marker: rgb("#15803D"),
    name-fill: rgb("#1C1917"),
    company-fill: rgb("#15803D"),
    headline-fill: rgb("#16A34A"),
    skill-label: rgb("#15803D"),
    skill-bg: rgb("#F0FDF4"),
    skill-border: rgb("#DCFCE7"),
  ),
