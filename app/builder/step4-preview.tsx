                ...
                >
                    ...
                    {originalScore && tailoredScore && (
                        ...
                        >
                            {improvement > 0 && (
                                <>
                                    <TrendingUp className="h-4 w-4" />+{improvement}% vs your original resume
                                </>
                            )}
                            {improvement < 0 && (
                                <>
                                    <TrendingDown className="h-4 w-4" />
                                    {improvement}% vs your original resume
                                </>
                            )}
                            {improvement === 0 && (
                                <>
                ...
                {tailoredScore?.breakdown && (
                    ...
                    >
                        ...
                        <p className="text-[11px] text-muted-foreground leading-relaxed">
                            Each block shows coverage for one JD bucket, how much it weights the total, and the
                            change vs your pre-tailor resume when available.
                        </p>
